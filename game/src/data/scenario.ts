...
export const ARCHIVE_CARD_SEEDS: Record<string, ArchiveCardSeed> = {
  ...
  "050": {
    ...
    category: "scenario",
    flavor:
      "다양한 우연과 기연을 통해, 편지를 보낸 이들은 새해를 맞이하는 의례에 참석합니다. 이 기적과도 같은 순간에 자신의 마음과 마주하고 진실한 답을 찾을 수 있을까요.\n\n효과: 라운드 승자가 받는 기본 [편지] 보상이 추가로 +1 증가합니다. 공주/왕자를 들고 승리했다면 해당 보상이 다시 +2 증가합니다. 라운드 종료 후 공주/왕자를 들고 승리했고 현재 루트의 편지 수가 단독 1위라면 「역사 9 운명의 순간」이 공개됩니다.",
    conditions: [],
  },
  "048": {
    id: "048",
